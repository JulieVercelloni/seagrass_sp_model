...
The aggregation distances of 150 and 200 meters results in a good balance between spatial (number of sub-transects) and temporal (number of replicated years) resolution (@fig-clust A & B). 150 meters shows more spatial locations but less temporal replicates, 200 meters presents the opposite characteristics.  
:::
...
* pick the aggregation distance (NH)
* rerun the analysis using periods within years (JV) 
* create lookup table for benthic class and seagrass types (persistent, opportunistic, other) (NH)
* create lookup table for dates and periods (NH) 
* check shapefile of banks (JV) 
* process water quality data (JV) 
:::